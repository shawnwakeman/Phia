<script context="module">import { createToaster, melt } from "@melt-ui/svelte";
const {
...
<script>import { AlertCircle, CheckCircle, Loader, XCircle } from "lucide-svelte";
...
>
	{#each $toasts as { id, data } (id)}
		{@const __MELTUI_BUILDER_1__ = $description(id)}
		{@const __MELTUI_BUILDER_0__ = $content(id)}
		<div
		...
		>
			...
			<p class="leading-relaxed" {...__MELTUI_BUILDER_1__} use:__MELTUI_BUILDER_1__.action>
				{data.text}
			</p>
		</div>
	{/each}
